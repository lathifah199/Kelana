<footer class="bg-[#D4C9E9]/60 border-t text-white mt-auto">
        ...
        <div class="flex gap-5 mt-6 md:mt-0">
            ...
            <a href="https://www.instagram.com/polibatamofficial">
                <img src="https://img.icons8.com/?size=100&id=32292&format=png&color=000000"
                     alt="Instagram"
                     class="w-[30px] h-[30px] filter invert">
            </a>
            ...
            <a href="https://wa.me/6289520428618">
    ...
    {{-- COPYRIGHT --}}
    <div class="text-center text-xs text-gray-500 py-3 bg-[#F7F7F7]">
        &copy; 2026 WayWay All rights reserved.
    </div>
