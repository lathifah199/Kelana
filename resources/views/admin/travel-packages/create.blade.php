...
@section('content')
    ...
    <div class="bg-white rounded-xl shadow-xl overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-purple-500 to-indigo-600 px-8 py-6">
            ...
            <p class="text-purple-100 mt-2">Add a new package to offer to travel agents</p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.travel-subscriptions.packages.store') }}" class="p-8">
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <!-- Max Packages -->
                    <div>
                        <label class="block text-gray-700 font-semibold mb-2">Max Travel Packages *</label>
                        ...
                        <p class="text-gray-500 text-xs mt-1">Maximum travel packages that can be created</p>
                        @error('max_packages')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
